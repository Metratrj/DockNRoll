    ...
    <div class="col-span-7 space-y-6">
      <div class="grid grid-cols-2 gap-6">
        <div class="rounded-2xl border border-gray-800 bg-white/[0.03] p-6">
          <div
            class="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-800"
          >
            <i class="fa-regular fa-server"></i>
          </div>
        </div>
        <div
          class="rounded-2xl border border-gray-800 bg-white/[0.03] p-6"
        ></div>
      </div>
    </div>
    <div class="col-span-5 space-y-6"></div>
